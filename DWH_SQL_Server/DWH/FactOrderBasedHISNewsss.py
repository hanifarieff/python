...
sys.stdout = open("C:/TestPython/DWH_SQL_Server/DWH/logs/LogFactOrderBasedHISNew.txt","w")
t0 = time.time()
...
def get_connections():
    ...
    return conn_his_live, conn_his,conn_ehr, conn_dwh_sqlserver

def get_source_data(conn_his,conn_ehr,conn_dwh_sqlserver):
    ...
    query_source = f"""
                        ...
                        WHERE
                        a.ordered_dttm >= '2024-09-30 00:00:00' AND a.ordered_dttm <= '2024-09-30 23:59:59'
...
def main():
    ...
    conn_his_live ,conn_his,conn_ehr, conn_dwh_sqlserver = get_connections()
    ...
    try:
        ...
        for x in range(day-4, day+1):
            ...
            source = get_source_data(conn_his, conn_ehr,conn_dwh_sqlserver)
            print("Source Data:")
            print(source)
            print(source.dtypes)
