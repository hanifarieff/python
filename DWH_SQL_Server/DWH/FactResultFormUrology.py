...
sys.stdout = open("C:/TestPython/DWH_SQL_Server/DWH/logs/LogFactResultFormUrology.txt","w")
...
if source.empty:
    ...
    if modified.empty:
        ...
        try:
            #update data
            updated_data(modified, 'FactResultFormUrology','OrderID','PatientID','AdmissionID','ObjID','SequenceID')
