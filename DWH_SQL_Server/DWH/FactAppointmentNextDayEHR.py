...
# bikin log ke file
sys.stdout = open("C:/TestPython/DWH_SQL_Server/DWH/logs/LogFactAppointmentNextDayEHR.txt","w")
t0 = time.time()
...
source = pd.read_sql_query(""" SELECT
                                    ...
                                    LEFT JOIN (SELECT x.employee_id, x.doctorbpjs_id
                                                FROM
                                                ...
                                                where x.ranked = 1) AS e ON e.employee_id = a.employee_id
                                    ...
                                    -- (a.appointment_dttm>= '2024-10-08 00:00:00' AND a.appointment_dttm <= '2024-10-08 23:59:59') 
...
source = source.drop_duplicates(subset=['AppointmentID'])
print(source)
