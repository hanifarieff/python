...
sys.stdout = open("C:/TestPython/DWH_SQL_Server/DWH/logs/LogFactOrderBasedEHRNew.txt","w")
t0 = time.time()
    ...
    query_source = f"""                            
                    SELECT 
                        ...
                        (
                            ...
                            WHERE
                            -- a.order_id = '00210007706311'
                            -- a.created_dttm >= '2025-02-25 00:00:00' AND a.created_dttm <= '2025-02-28 23:59:59'
