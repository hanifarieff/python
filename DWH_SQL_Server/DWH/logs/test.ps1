$ScheduledTaskName = ((Get-ScheduledTaskInfo -TaskName "\Sql_LoadFactPatientDrugDispense").TaskName)
$Result = ((Get-ScheduledTaskInfo -TaskName "\Sql_LoadFactPatientDrugDispense").LastTaskResult)
