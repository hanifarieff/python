...
# bikin log ke file
sys.stdout = open("C:/TestPython/DWH_SQL_Server/DWH/logs/LogFactFormulirLabEHR.txt","w")
t0 = time.time()
...
source = pd.read_sql_query("""
                           SELECT 
							...
							AND
                            --  CAST(a.CreatedDate as date) >= '2023-12-30' AND CAST(a.CreatedDate as date) <= '2023-12-31'
