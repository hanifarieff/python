...
# bikin log ke file
sys.stdout = open("C:/TestPython/DWH_SQL_Server/DWH/logs/LogFactFormulirLab.txt","w")
t0 = time.time()
...
source = pd.read_sql_query("""
                           SELECT 
							...
							AND
                            -- a.CreatedDate >= '2024-01-01 00:00:00' AND a.CreatedDate <= '2024-01-01 23:59:59'
                            ...
                            -- CAST(a.UpdateDateStaging as date) >= '2023-06-21' AND CAST(a.UpdateDateStaging as date) <= '2023-06-21' 
                            -- AND a.PatientID IN (1974656,112426) AND a.AdmissionID IN (173,1)
                            -- AND a.FormNumber IN (411800416,411669458)
...
if source.empty:
    ...
    if len(source) == 1:        
        ...
        formnumber = tuple(source["FormNumber"].unique())
