...
sys.stdout = open("C:/TestPython/DWH_SQL_Server/DWH/logs/LogFactAttendanceEmployeeManual.txt","w")
t0 = time.time()
...
attendance_df = pd.read_sql_query(""" 
                        ...
                        where 
                        employee_ext_id IN ('NPS143959') 
                        and attendance_date >= '2025-02-01' and attendance_date <= '2025-02-28' and
                        employee_ext_id NOT IN ('')
...
siknet_df = pd.read_sql_query(""" 
                        ...
                        from tbltransidp
                        where 
                        nip IN ('NPS143959') AND
                        and tglwktmasuk >= '2025-02-01 00:00:00' and tglwktkeluar <= '2025-02-28 23:59:59' AND
                        nip NOT IN ('')
