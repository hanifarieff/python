...
def get_connections():
    ...
    return conn_his_live,conn_ehr, conn_dwh_sqlserver,conn_staging_sqlserver
...
def get_source_data(conn_his_live,conn_ehr,conn_dwh_sqlserver):
    ...
    query_source = f"""
                        ...
                        WHERE
                        -- a.created_dttm >= '2025-02-16 00:00:00' AND a.created_dttm <= '2025-02-20 23:59:59'
    ...
    new_order_columns = ['OrderID','PatientID','AdmissionID','EmployeeID','DoctorName','KSM','NIP','NIK','PatientName','MedicalNo','SEPNo',
                        ...
                        'CategoryName','PayplanKemkes','Type','Status','ObjectGroupingName','BillingPaid','OrgID','TarifClass','AnesthesiaCode']
...
def get_target_data(source, conn_dwh_sqlserver):
    ...
    query_filter = f"""SELECT OrderID,PatientID,AdmissionID,EmployeeID,DoctorName,KSM,NIP,NIK,PatientName,MedicalNo,SEPNo,OrgName,AdmissionDate,
                        ...
                        JasaRemun,PayplanName,CategoryName,PayplanKemkes,Type,Status,ObjectGroupingName,BillingPaid, OrgID,TarifClass,AnesthesiaCode
...
def main():
    ...
    conn_his_live,conn_ehr, conn_dwh_sqlserver, conn_staging_sqlserver = get_connections()
