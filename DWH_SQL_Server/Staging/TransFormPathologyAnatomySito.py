...
sys.stdout = open("C:/TestPython/DWH_SQL_Server/Staging/logs/LogTransFormPathologyAnatomySito.txt","w")
...
source = pd.read_sql_query(""" 
                            SELECT  
                                ...
                                -- MRN ambil ke MPI
                                lab.cr_ambil AS TissueSource, -- asal jaringan,
                            ...
                            FROM xocp_his_pa_form_sitopatologi lab
                            ...
                            where 
                            lab.created_dttm >= '2024-10-26 00:00:00' and lab.created_dttm <= '2024-10-31 23:59:59'
                            ...
                            -- lab.no_pa_id IN ('C24-02108','C24-02612','LC24-0040','C24-02767')
                            GROUP BY 
                                lab.patient_id,
                                lab.admission_id,
                                lab.form_number,
