...
source = pd.read_sql_query(""" SELECT
                                ...
                                -- and a.patient_id = 1223894 AND a.admission_id = 1
                                ...
                                -- and e.order_dttm >= '2024-02-01 00:00:00' and e.order_dttm <= '2024-02-01 23:59:59'
                                AND (e.order_dttm >= DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 1 DAY), "%%Y-%%m-%%d 00:00:00") AND e.order_dttm <= DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 1 DAY), "%%Y-%%m-%%d 23:59:59")) 
