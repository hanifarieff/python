...
source = pd.read_excel(r'C:\TestPython\Data RME SATUSEHAT.xlsx',sheet_name='Sheet1')
...
try:
    source.to_sql('ListPatientRMESatuSehat',schema='staging_rscm',con=conn_staging_sqlserver, if_exists='replace',index=False)
    print('ok')
