...
sys.stdout = open("C:/TestPython/DWH_SQL_Server/Staging/logs/LogTransResultFormUrology.txt","w")
...
def translate_same_obj(obj_id, conn_his_live, source):
    """ Fungsi ini untuk translate value Obj 53835 (Lokasi Batu),163039 (Riwayat Penyakit),
