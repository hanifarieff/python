...
sys.stdout = open("C:/TestPython/DWH_SQL_Server/Staging/logs/LogTransFormPathologyAnatomyImuno.txt","w")
...
source = pd.read_sql_query(""" 
                            ...
                            FROM xocp_his_pa_form_imunohistokimia lab
                            ...
                            where 
                            lab.created_dttm >= '2024-10-21 00:00:00' and lab.created_dttm <= '2024-10-31 23:59:59'
														-- and btr.trnsct_dttm IS NULL
                            -- and lab.no_pa_id = 'LH24-0339'
                            -- lab.patient_id = 1054602 and lab.admission_id = 10
                            -- and adm.payplan_id NOT IN('8','71')
                            -- lab.no_pa_id IN ('K24-02443','K24-02446','LK24-0840','K23-03840')
                            GROUP BY 
                                lab.patient_id,
                                lab.admission_id,
                                lab.form_number,
