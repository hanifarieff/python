...
source1 = pd.read_sql_query(""" SELECT 
                            ...
                            -- (pt.created_dttm >= '2024-10-23 00:00:00' and pt.created_dttm <= '2024-10-23 23:59:59')
                            ...
                            and pt.created_dttm <= DATE_FORMAT(NOW(), "%%Y-%%m-%%d 23:59:59")) 
...
source2 = pd.read_sql_query(""" SELECT 
                            ...
                            and pr.updated_dttm <= DATE_FORMAT(NOW(), "%%Y-%%m-%%d 23:59:59"))
                            -- AND pr.person_nm IS NOT NULL
 """, conn_mpi)
