...
query_source1 = f""" SELECT 
                            ...
                            -- (pt.created_dttm >= '2024-12-09 00:00:00' and pt.created_dttm <= '2024-12-09 23:59:59')
                            -- (pr.updated_dttm >= '2023-10-12 00:00:00' and pr.updated_dttm <= '2023-10-12 23:59:59')
                            (pt.created_dttm >= '{start_date} 00:00:00' and pt.created_dttm <= '{end_date} 23:59:59') 
                            -- AND pr.person_nm IS NOT NULL"""

source1 = pd.read_sql_query(query_source1, conn_mpi)
...
query_source2 = f""" SELECT 
                            ...
                            (pr.updated_dttm >= '{start_date} 00:00:00' and pr.updated_dttm <= '{end_date} 23:59:59')
                            -- AND pr.person_nm IS NOT NULL"""
source2 = pd.read_sql_query(query_source2,conn_mpi)
